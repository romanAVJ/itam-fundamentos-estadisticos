...
1) una gráfica de cuantiles muestrales

2) un histograma

3) una gráfica de cuantiles normales
...
**Respuesta**: *No creo que esté relacionada del todo. Aprox 65% de las veces está arriba de 3 unidades (1 desv estandar).*
...
df_enlace |> head()
```
This data are paired data, so the bootstrap should be by row
```{r enlace-corr}
set.seed(SEED)
